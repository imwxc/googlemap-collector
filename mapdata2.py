...
def getimg(Tpath, Spath, x, y):
    ...
    for a in range(0, 7):
        try:
            ...
            req.add_header('User-Agent', agents[a])
            ...
            continue #从8个请求头中轮流顺序选择

if __name__ == "__main__":
    for zoom in [17] :
        path = r"/home/machine/code/dataset/streetmapNY" + str(zoom)
        ...
        print(str(lefttop[0] - rightbottom[0]))
        print(str(lefttop[1] - rightbottom[1]))
        ...
        for x in range(lefttop[0], rightbottom[0]):
            for y in range(lefttop[1], rightbottom[1]):
                ...
                if os.access(c, os.F_OK) == True:
                    ...
                    tilepath = "http://mt2.google.cn/vt/lyrs=m&scale=2&hl=zh-CN&gl=cn&x=" + str(x) + "&y=" + str(
                        y) + "&z=" + str(zoom) + "&apistyle=s.t%3A3%7Cs.e%3Al.t%7Cp.v%3Aoff%2Cs.t%3A2%7Cp.v%3Aoff%2Cs.t%3A1%7Cs.e%3Al%7Cp.v%3Aoff%2Cs.t%3A5%7Cs.e%3Al%7Cp.v%3Aoff%2Cs.e%3Al%7Cp.v%3Aoff&style=api%7Csmartmaps"
                    # 天地图的url 可以换成谷歌地图的
